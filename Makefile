...
CXXFLAGS += -Werror -Wformat-security -Wignored-qualifiers -Winit-self \
		...
		-Woverloaded-virtual -Wsign-promo -Wextra -pedantic -Wno-deprecated -msse -msse2
...
$(BIN_DIR)/task2: $(OBJ_DIR)/task2.o $(OBJ_DIR)/newmain.o bridge.touch	
	$(CXX) $(CXXFLAGS) $(filter %.o, $^) -o $@ $(LDFLAGS)
$(BIN_DIR)/test: $(OBJ_DIR)/test.o $(OBJ_DIR)/task2.o bridge.touch
	$(CXX) $(CXXFLAGS) $(filter %.o, $^) -o $@ $(LDFLAGS) -lgtest -lpthread
